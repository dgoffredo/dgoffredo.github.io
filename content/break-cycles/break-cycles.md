...
![dependency graph of "Value"](just-value.dot.png)
...
<div><img src="cyclic.remove.1.dot.png"/><img src="cyclic.remove.2.dot.png"/></div>
...
<div><img src="cyclic.remove.3.dot.png"/><img src="cyclic.remove.4.dot.png"/></div>
...
<div><img src="cyclic.remove.5.dot.png"/><img src="cyclic.remove.6.dot.png"/></div>
...
![maximum number of cycles in complete digraph with n vertices](max-cycles.png)
...
<div><img src="graph-animation-4.gif"/><img src="edges-removed-d.png"/></div>

As you can see, one of the edges is different than before.

The punchline is the result starting from `F`. Here it is:

<div><img src="graph-animation-5.gif"/><img src="edges-removed-f.png"/></div>
